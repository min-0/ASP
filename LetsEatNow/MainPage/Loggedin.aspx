<%@ Page Title="" Language="C#" MasterPageFile="~/Home/home.Master" AutoEventWireup="true" CodeFile="Loggedin.aspx.cs" Inherits="Home_Loggedin" %>
                ...
                <table class="auto-style15" align="center">
                    ...
                    <tr>
                        <td class="auto-style24">
                            <asp:Button ID="Button1" runat="server" CssClass="auto-style26" Height="57px" Text="음식 종류" Width="261px" BackColor="#FCD5B5" BorderColor="#E46C0A" OnClick="Button1_Click" PostBackUrl="~/FoodType/FoddType.aspx" />
                        </td>
                        <td class="auto-style24">
            ...
            <td class="auto-style45">
                <asp:Panel ID="Panel3" runat="server" BorderColor="#385D8A" BorderStyle="Solid" CssClass="auto-style46">
                    <div class="auto-style47">
                        <br class="auto-style68" />
                        &nbsp; <span class="auto-style44">&nbsp;&nbsp; 닉네임 : </span>
                        <asp:Label ID="Label25" runat="server" CssClass="auto-style44"></asp:Label>
                        <br class="auto-style44" />
                        <br class="auto-style44" />
                        <span class="auto-style44">&nbsp;&nbsp;&nbsp;&nbsp; 회원 등급 : </span>
                        <asp:Label ID="Label26" runat="server" CssClass="auto-style44"></asp:Label>
                        <br class="auto-style44" />
                        <span class="auto-style44">&nbsp; </span>
                        <br class="auto-style44" />
                        <span class="auto-style44">&nbsp;&nbsp;&nbsp;&nbsp; 내가 쓴 리뷰 : </span>
                        <asp:Label ID="Label27" runat="server" CssClass="auto-style44"></asp:Label>
                        <span class="auto-style44">&nbsp;개</span><br class="auto-style44" />
                        <br class="auto-style44" />
                        <span class="auto-style44">&nbsp;&nbsp;&nbsp; </span>
                        <asp:Button ID="Button7" runat="server" CssClass="auto-style44" PostBackUrl="~/즐겨찾기Page.aspx" Text="즐겨찾기" />
                        <span class="auto-style44">&nbsp;&nbsp;&nbsp; </span>
                        <asp:Button ID="Button8" runat="server" CssClass="auto-style44" PostBackUrl="~/MyPage/MyPage.aspx" Text="마이페이지" />
                    </div>
                </asp:Panel>
            </td>
        </tr>
