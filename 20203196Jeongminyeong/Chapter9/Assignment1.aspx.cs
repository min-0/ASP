...
public partial class Chapter9_Assignment1 : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            while (reader.Read())
            {
                ...
                r.Cells.Add(c1);
                // 필드( au_lname ) 값 추출하여 테이블 cell에 넣기
                ...
                c4.Controls.Add(new LiteralControl(reader["state"].ToString()));
                r.Cells.Add(c7);
                // 필드( zip ) 값 추출하여 테이블 cell에 넣기 
                TableCell c8 = new TableCell();
                c5.Controls.Add(new LiteralControl(reader["zip"].ToString()));
                r.Cells.Add(c8);
                // 필드( contract ) 값 추출하여 테이블 cell에 넣기
                TableCell c9 = new TableCell();
                c6.Controls.Add(new LiteralControl(reader["contract"].ToString()));
                r.Cells.Add(c9);
